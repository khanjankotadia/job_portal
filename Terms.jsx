  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ backgroundImage: "url(assets/images/heading-5-1920x500.jpg)" }}
      >
        <div class="container">
          <div class="row">
            <div class="col-md-12">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <p>
                ...
                facilis quidem fuga maiores. Quasi, obcaecati? <br />
                <br /> Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Sequi, est officiis. Ipsam quas consequuntur adipisci quis, fuga
                pariatur eius eveniet qui similique nulla inventore accusantium,
                suscipit asperiores quibusdam culpa iure!
              </p>
